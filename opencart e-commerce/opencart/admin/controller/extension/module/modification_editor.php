<?php
class ControllerExtensionModuleModificationEditor extends Controller {
    public function index() {
        if (!$this->user->hasPermission('modify', 'extension/module/modification_editor')) {
            $this->response->redirect($this->url->link('marketplace/modification', 'user_token=' . $this->session->data['user_token'], true));
        }

        $this->load->language('extension/module/modification_editor');
        ...
        if (isset($this->request->get['modification_id'])) {
            ...
            $this->load->model('extension/module/modification_editor');
            $modification_info = $this->model_extension_module_modification_editor->getModification($modification_id);
            ...
            if ($modification_info) {
                ...
                $data['breadcrumbs'][] = array(
                    ...
                    'href' => $this->url->link('extension/module/modification_editor', 'user_token=' . $this->session->data['user_token'] . '&modification_id=' . $modification_id, true)
                );
            } else {
                $this->response->redirect($this->url->link('marketplace/modification', 'user_token=' . $this->session->data['user_token'], true));
            }
            ...
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title'),
                'href' => $this->url->link('extension/module/modification_editor', 'user_token=' . $this->session->data['user_token'], true)
            );
        }
        ...
        $this->response->setOutput($this->load->view('extension/module/modification_editor', $data));
    }
                ...
                try {
                    ...
                    if (isset($this->request->post['modification_id'])) {
                        ...
                        if ($modification_id > 0) {
                            ...
                            if ($modification_info) {
                                $this->model_extension_module_modification_editor->editModification($modification_id, $modification_data);
                            ...
                            if ($modification_info) {
                                ...
                                $this->model_extension_module_modification_editor->addModification($modification_data);
    ...
    public function download() {
        ...
        $this->load->model('extension/module/modification_editor');
        $modification = $this->model_extension_module_modification_editor->getModification($modification_id);
